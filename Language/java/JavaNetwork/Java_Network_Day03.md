...
> 프로그램 작성 (3일간)
>
> * 여러개의 방에서 채팅을 진행하는 프로그램을 작성
> * 프로그램 스킬을 늘리기에 상당히 좋다.
> * 어떤 기능을 갖고 프로그램을 작성할건지는 클라이언트 프로그램을 작성하면서 알아보자.
...
* 위 코드는 네트워크 연결 없이 Client UI 구성만 이룸.

* 결과

  ![image-20200420105005588](Java_Network_Day03.assets/image-20200420105005588.png)

  ![image-20200420105031676](Java_Network_Day03.assets/image-20200420105031676.png)

  ![image-20200420105045896](Java_Network_Day03.assets/image-20200420105045896.png)

  ![image-20200420105109312](Java_Network_Day03.assets/image-20200420105109312.png)