...
public class paintPanel extends JPanel{
	...
	public void addComponent() {
		...
		addRadioButton(bg_color, c_panel, "검정", new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				color_name = Color.black;
			}
		});
		addRadioButton(bg_color, c_panel, "파랑", new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				color_name = Color.blue;
			}
		});
		addRadioButton(bg_color, c_panel, "초록", new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				color_name = Color.green;
			}
		});
		addRadioButton(bg_color, c_panel, "주황", new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				color_name = Color.orange;
			}
		});
		addRadioButton(bg_color, c_panel, "노랑", new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		...
		addButton(sh_panel,"ㆍ", null, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b_info=6;
			}
		});
		...
		addButton(sh_panel, "클리어", Color.gray,new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				List.clear();
	...
	public class drawing extends JPanel{
		...
		public void paintComponent(Graphics g){
			System.out.println("페인트 컴포넌트 실행된다.");
